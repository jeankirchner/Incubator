...
import flowbuilder.diagram.figure.ActivityFigure;
...
public class ActivityEditPart extends AbstractGraphicalEditPart implements PropertyChangeListener, NodeEditPart{
		...
		protected IFigure createFigure() {
			IFigure f = new ActivityFigure(getCastedModel().getText());
			f.setOpaque(true); // non-transparent figure
			f.setBackgroundColor(new Color(null, new RGB(250, 250, 141)));
			return f;
		}
		...
		private ActivityComponent getCastedModel() {
			return (ActivityComponent) getModel();
		}
