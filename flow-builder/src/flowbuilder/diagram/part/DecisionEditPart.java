...
import flowbuilder.diagram.figure.DecisionFigure;
...
public class DecisionEditPart extends AbstractGraphicalEditPart implements PropertyChangeListener, NodeEditPart{
		...
		private DecisionComponent getCastedModel() {
			return (DecisionComponent) getModel();
		}
