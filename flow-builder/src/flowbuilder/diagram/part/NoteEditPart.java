...
import flowbuilder.diagram.figure.NoteFigure;
...
public class NoteEditPart extends AbstractGraphicalEditPart implements PropertyChangeListener, NodeEditPart{
	...
	protected IFigure createFigure() {
		IFigure f = new NoteFigure(getCastedModel().getText());
	...
	private NoteComponent getCastedModel() {
		return (NoteComponent) getModel();
	}
