...
public class WavFile_Backup {
	...
	public static WavFile_Backup newWavFile(String file, int numChannels, long numFrames, int validBits, long sampleRate) throws IOException, WavFileException {
		return newWavFile(new File(file), numChannels, numFrames, validBits, sampleRate);
	}

	public static WavFile_Backup newWavFile(File file, int numChannels, long numFrames, int validBits, long sampleRate) throws IOException, WavFileException {
		return newWavFile(new BufferedOutputStream(new FileOutputStream(file)), numChannels, numFrames, validBits, sampleRate);
	}

	public static WavFile_Backup newWavFile(int numChannels, long numFrames, int validBits, long sampleRate) throws IOException, WavFileException {
		return newWavFile(new ByteArrayOutputStream(), numChannels, numFrames, validBits, sampleRate);
	}

	public static WavFile_Backup newWavFile(OutputStream outStream, int numChannels, long numFrames, int validBits, long sampleRate) throws IOException, WavFileException {
		// Instantiate new Wavfile and initialise
		WavFile_Backup wavFile = new WavFile_Backup();
	...
	public static WavFile_Backup openWavFile(String fileName) throws IOException, WavFileException {
		return openWavFile(new File(fileName));
	}

	public static WavFile_Backup openWavFile(File file) throws IOException, WavFileException {
		// Instantiate new Wavfile and store the file reference
		WavFile_Backup wavFile = new WavFile_Backup();

		// Create a new file input stream for reading file data
		wavFile.iStream = new BufferedInputStream(new FileInputStream(file));
	...
	public long[] readFrames(int numFramesToRead) throws IOException, WavFileException {
		long[] frames = new long[numFramesToRead];
		readFrames(frames, numFramesToRead);
		return frames;
	}
