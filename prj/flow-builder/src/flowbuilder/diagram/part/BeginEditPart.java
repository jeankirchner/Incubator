...
import flowbuilder.diagram.figure.BeginFigure;
...
public class BeginEditPart extends AbstractGraphicalEditPart implements PropertyChangeListener, NodeEditPart {
	...
	private BeginComponent getCastedModel() {
		return (BeginComponent) getModel();
	}
