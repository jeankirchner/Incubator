...
import flowbuilder.diagram.figure.TextFigure;
...
public class TextEditPart extends AbstractGraphicalEditPart implements PropertyChangeListener, NodeEditPart{
	...
	protected IFigure createFigure() {
		IFigure f = new TextFigure(getCastedModel().getText());
	...
	private TextComponent getCastedModel() {
		return (TextComponent) getModel();
	}
