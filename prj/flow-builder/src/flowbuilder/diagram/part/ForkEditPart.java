...
import flowbuilder.diagram.figure.ForkFigure;
...
public class ForkEditPart extends AbstractGraphicalEditPart implements PropertyChangeListener, NodeEditPart{
	...
	private ForkComponent getCastedModel() {
		return (ForkComponent) getModel();
	}
